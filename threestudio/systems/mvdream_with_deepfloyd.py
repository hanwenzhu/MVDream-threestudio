...
@threestudio.register("mvdream-with-deepfloyd")
class MVDreamWithDeepFloydSystem(MVDreamSystem):
    """Adds DeepFloyd guidance to MVDream"""

    def configure(self) -> None:
        # set up geometry, material, background, renderer, guidance, prompt processor
        super().configure()
